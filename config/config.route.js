    ...
    routes: [
      ...
      // CRITERIA
      {
        ...
        routes: [
          {
            path: '/bep',
            redirect: '/bep/trang-chu',
          },
          {
           path: '/bep/trang-chu',
           component: './waiting-page',
           wrappers: ['@/wrappers/auth'],
           authority: [`${FLATFORM.WEB}${permissions.BEP}${ACTION.VIEW}`],
         },
          {
            path: '/bep/thuc-don',
            component: './menu/kitchen-menus/index',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHSACHTHUCDON}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/tao-moi',
            component: './menu/kitchen-menus/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHSACHTHUCDON}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/:id/chinh-sua',
            component: './menu/kitchen-menus/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHSACHTHUCDON}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/:id/chi-tiet',
            component: './menu/kitchen-menus/details',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHSACHTHUCDON}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/bua-an',
            component: './menu/meals',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHMUCBUAAN}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/bua-an/tao-moi',
            component: './menu/meals/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHMUCBUAAN}${ACTION.CREATE}`],
          },
          {
            path: '/bep/thuc-don/bua-an/:id/chi-tiet',
            component: './menu/meals/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHMUCBUAAN}${ACTION.EDIT}`],
          },
          {
            path: '/bep/thuc-don/mon-an',
            component: './menu/food-commons',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHMUCMONAN}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/mon-an/tao-moi',
            component: './menu/food-commons/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHMUCMONAN}${ACTION.CREATE}`],
          },
          {
            path: '/bep/thuc-don/mon-an/:id/chi-tiet',
            component: './menu/food-commons/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_DANHMUCMONAN}${ACTION.EDIT}`],
          },
          {
            path: '/bep/thuc-don/hoc-sinh-bi-di-ung',
            component: './menu/student-allergy',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_HOCSINHBIDIUNG}${ACTION.VIEW}`],
          },
          {
            path: '/bep/thuc-don/hoc-sinh-can-doi-mon',
            component: './menu/student-exchange-food',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_HOCSINHCANDOIMON}${ACTION.VIEW}`],
          },
           {
            path: '/bep/thuc-don/cau-hinh-ap-dung',
            component: './menu/applicable-configuration',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.BEP_CAUHINHAPDUNG}${ACTION.VIEW}`],
          },
        ],
      },
      {
      ...
      // OBJECT PROFILES
      {
        ...
        routes: [
          {
            path: '/ho-so-doi-tuong',
            redirect: '/ho-so-doi-tuong/trang-chu',
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_HSDT_HOCSINH_VIEW],
          },
          {
            path: '/ho-so-doi-tuong/hoc-sinh/tao-moi',
            component: './object-profiles/children/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_HSDT_HOCSINH_CREATE],
          },
          {
          ...
          },
          {
            ...
            component: './object-profiles/children/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_HSDT_HOCSINH_EDIT],
          },
          {
            path: '/ho-so-doi-tuong/phu-huynh',
            component: './object-profiles/parents',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_HSDT_PHUHUYNH_VIEW],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_HSDT_PROFILEHOCSINH_VIEW],
          },
        ],
      },
      // OBJECT PROFILES
      ...
      // HRM
      {
        ...
        routes: [
          {
            path: '/quan-ly-nhan-su',
            redirect: '/quan-ly-nhan-su/trang-cho',
          },
          {
           path: '/quan-ly-nhan-su/trang-cho',
           component: './waiting-page',
           wrappers: ['@/wrappers/auth'],
           authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
         },
          {
          ...
          {
            path: '/quan-ly-nhan-su/bao-cao/tham-nien-cong-tac',
            component: './hrm/report/working-seniority',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/bao-cao/nhan-vien-thoi-viec',
            component: './hrm/report/employee-leave',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
          ...
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-level',
            component: './hrm/recruitment/level-configuration',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHLEVEL}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-level/tao-moi',
            component: './hrm/recruitment/level-configuration/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHLEVEL}${ACTION.CREATE}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-level/:id/chi-tiet',
            component: './hrm/recruitment/level-configuration/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHLEVEL}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-level/:id/chinh-sua',
            component: './hrm/recruitment/level-configuration/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHLEVEL}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-tuyen-dung',
            component: './hrm/recruitment/recruitment-configuration',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHTUYENDUNG}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-tuyen-dung/tao-moi',
            component: './hrm/recruitment/recruitment-configuration/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHTUYENDUNG}${ACTION.CREATE}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-tuyen-dung/:id/chi-tiet',
            component: './hrm/recruitment/recruitment-configuration/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHTUYENDUNG}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-tuyen-dung/:id/chinh-sua',
            component: './hrm/recruitment/recruitment-configuration/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHTUYENDUNG}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/cau-hinh-loi-cam-on',
            component: './hrm/recruitment/thank-configuration',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_CAUHINHLOICAMON}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-tuyen-dung',
            component: './hrm/recruitment/recruitment-list',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_DANHSACHTUYENDUNG}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-tuyen-dung/tao-moi',
            component: './hrm/recruitment/recruitment-list/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_DANHSACHTUYENDUNG}${ACTION.CREATE}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-tuyen-dung/:id/chinh-sua',
            component: './hrm/recruitment/recruitment-list/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_DANHSACHTUYENDUNG}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-tuyen-dung/:id/chi-tiet',
            component: './hrm/recruitment/recruitment-list/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_DANHSACHTUYENDUNG}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-tuyen-dung/:id/tao-moi-nhan-vien',
            component: './hrm/recruitment/recruitment-list/create-user',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_DANHSACHTUYENDUNG}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-tuyen-dung/:id/chi-tiet-nhan-vien',
            component: './hrm/recruitment/recruitment-list/detail-user',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_DANHSACHTUYENDUNG}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-luu-tru',
            component: './hrm/recruitment/storage',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_LUUTRU}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/tuyen-dung/danh-sach-luu-tru/:id/chi-tiet',
            component: './hrm/recruitment/recruitment-list/detail-user',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_LUUTRU}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/tieu-chi-danh-gia',
            component: './hrm/interview-manager/category/evaluation-criteria',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_TIEUCHIDANHGIA}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/tieu-chi-danh-gia/tao-moi',
            component: './hrm/interview-manager/category/evaluation-criteria/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_TIEUCHIDANHGIA}${ACTION.CREATE}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/tieu-chi-danh-gia/:id/chi-tiet',
            component: './hrm/interview-manager/category/evaluation-criteria/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_TIEUCHIDANHGIA}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/tieu-chi-danh-gia/:id/chinh-sua',
            component: './hrm/interview-manager/category/evaluation-criteria/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_TIEUCHIDANHGIA}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/diem-danh-gia',
            component: './hrm/interview-manager/category/point-evaluation',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_DIEMDANHGIA}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/nguoi-phong-van',
            component: './hrm/interview-manager/category/interviewer',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_NGUOIPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/nguoi-phong-van/tao-moi',
            component: './hrm/interview-manager/category/interviewer/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_NGUOIPHONGVAN}${ACTION.CREATE}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/nguoi-phong-van/:id/chi-tiet',
            component: './hrm/interview-manager/category/interviewer/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_NGUOIPHONGVAN}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/nguoi-phong-van/:id/chinh-sua',
            component: './hrm/interview-manager/category/interviewer/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_NGUOIPHONGVAN}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/cau-hinh-phong-van',
            component: './hrm/interview-manager/category/interview-configuration',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_CAUHINHPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/cau-hinh-phong-van/tao-moi',
            component: './hrm/interview-manager/category/interview-configuration/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_CAUHINHPHONGVAN}${ACTION.CREATE}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/cau-hinh-phong-van/:id/chi-tiet',
            component: './hrm/interview-manager/category/interview-configuration/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_CAUHINHPHONGVAN}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/cau-hinh-phong-van/:id/chinh-sua',
            component: './hrm/interview-manager/category/interview-configuration/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_CAUHINHPHONGVAN}${ACTION.EDIT}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-sach-phong-van',
            component: './hrm/interview-manager/interview-list',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHSACHPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-sach-phong-van/tao-moi',
            component: './hrm/interview-manager/interview-list/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHSACHPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-sach-phong-van/:id/chi-tiet',
            component: './hrm/interview-manager/interview-list/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHSACHPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/danh-sach-phong-van/:id/chinh-sua',
            component: './hrm/interview-manager/interview-list/create',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHSACHPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/lam-phong-van',
            component: './hrm/interview-manager/do-interview',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_TUYENDUNG_LUUTRU}${ACTION.DETAIL}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/lam-phong-van/:id/chi-tiet',
            component: './hrm/interview-manager/do-interview/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_LAMPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/lam-phong-van/:id/phong-van',
            component: './hrm/interview-manager/do-interview/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_LAMPHONGVAN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/duyet-ung-vien',
            component: './hrm/interview-manager/browse-candidates',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DUYETUNGVIEN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-phong-van/duyet-ung-vien/:id/chi-tiet',
            component: './hrm/interview-manager/browse-candidates/detail',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DUYETUNGVIEN}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/tieu-chi-danh-gia',
            component: './hrm/probation-manager/category/evaluation-criteria',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/tieu-chi-danh-gia/tao-moi',
            component: './hrm/probation-manager/category/evaluation-criteria/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/tieu-chi-danh-gia/:id/chi-tiet',
            component: './hrm/probation-manager/category/evaluation-criteria/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/tieu-chi-danh-gia/:id/chinh-sua',
            component: './hrm/probation-manager/category/evaluation-criteria/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/diem-danh-gia',
            component: './hrm/probation-manager/category/point-evaluation',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/nguoi-danh-gia',
            component: './hrm/probation-manager/category/assessor',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/nguoi-danh-gia/tao-moi',
            component: './hrm/probation-manager/category/assessor/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/nguoi-danh-gia/:id/chi-tiet',
            component: './hrm/probation-manager/category/assessor/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/nguoi-danh-gia/:id/chinh-sua',
            component: './hrm/probation-manager/category/assessor/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/cau-hinh-danh-gia',
            component: './hrm/probation-manager/category/rating-configuration',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/cau-hinh-danh-gia/tao-moi',
            component: './hrm/probation-manager/category/rating-configuration/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/cau-hinh-danh-gia/:id/chi-tiet',
            component: './hrm/probation-manager/category/rating-configuration/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-muc/cau-hinh-danh-gia/:id/chinh-sua',
            component: './hrm/probation-manager/category/rating-configuration/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-sach-thu-viec',
            component: './hrm/probation-manager/probationary-assessment-list',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-sach-thu-viec/tao-moi',
            component: './hrm/probation-manager/probationary-assessment-list/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-sach-thu-viec/:id/chi-tiet',
            component: './hrm/probation-manager/probationary-assessment-list/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-sach-thu-viec/:id/chinh-sua',
            component: './hrm/probation-manager/probationary-assessment-list/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-gia-thu-viec',
            component: './hrm/probation-manager/probationary-assessment',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-gia-thu-viec/:id/chi-tiet',
            component: './hrm/probation-manager/probationary-assessment/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/danh-gia-thu-viec/:id/danh-gia',
            component: './hrm/probation-manager/probationary-assessment/create',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/duyet-nhan-su-thu-viec',
            component: './hrm/probation-manager/browse-probationary-personnel',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
          {
            path: '/quan-ly-nhan-su/quan-ly-thu-viec/duyet-nhan-su-thu-viec/:id/chi-tiet',
            component: './hrm/probation-manager/browse-probationary-personnel/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.HRM}${ACTION.VIEW}`],
          },
        ],
      ...
      {
        path: '/ung-vien/:id',
        component: './hrm/recruitment/web-form',
      },
      // ALLOCATION
      {
        path: '/phan-bo',
        routes: [
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_PHANLOP_CAUHINHDANGKYNGOAIGIO_VIEW],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_PHANLOP_BAOCAO_VIEW],
          },
          {
      ...
      // MEDICAL
      {
        ...
        routes: [
          ...
          {
            path: '/y-te/danh-muc-su-co',
            component: './medical/list-trouble',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.YTE],
          },
          {
            path: '/y-te/danh-muc-su-co/tao-moi',
            component: './medical/list-trouble/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.YTE],
          },
          {
            path: '/y-te/danh-muc-su-co/:id/chi-tiet',
            component: './medical/list-trouble/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.YTE],
          },
      ...
      },
      {
        ...
        routes: [
          {
            path: '/thoi-khoa-bieu',
            redirect: '/thoi-khoa-bieu/trang-chu',
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_TKBTUDONG_VIEW],
          },
          {
            path: '/thoi-khoa-bieu/lam-viec',
            component: './timetable/schedules',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_LICHLAMVIECSUKIEN_VIEW],
          },
          {
          ...
          {
            path: '/thoi-khoa-bieu/thoi-khoa-bieu-tre',
            component: './timetable/children',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_TKBCUATRE_VIEW],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_LICHSU_VIEW],
          },
          {
            path: '/thoi-khoa-bieu/cau-hinh-thoi-gian',
            component: './timetable/time-config',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_CAUHINHTHOIGIAN_VIEW],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_DANHMUC_NHOMHOATDONG_VIEW],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_THONGKETIEMCAN_VIEW],
          },
          {
            path: '/thoi-khoa-bieu/thong-ke-bao-cao-phu-huynh-tham-gia-su-kien',
            component: './timetable/report',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TKB_THONGKEBAOCAO_VIEW],
          },
        ],
      },
      // MEDICAL
      ...
      // FEE POLICY
      {
        ...
        routes: [
          ...
          {
            path: '/chinh-sach-phi/bao-cao/bao-cao-tien-hoan-phi',
            component: './fee-policy/report/refund-reports',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CHINHSACHPHI],
          },
        ],
      ...
      },
      {
        ...
        routes: [
          ...
          {
            path: '/crm/danh-muc/ph-tiem-nang',
            component: './crm/parents-potential',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/ph-tiem-nang/tao-moi',
            component: './crm/parents-potential/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/ph-tiem-nang/:id/chi-tiet',
            component: './crm/parents-potential/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tim-kiem',
            component: './crm/search',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tim-kiem/tao-moi',
            component: './crm/search/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tim-kiem/:id/chi-tiet',
            component: './crm/search/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tags',
            component: './crm/tags',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tinh-thanh',
            component: './crm/city',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tinh-thanh/tao-moi',
            component: './crm/city/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/tinh-thanh/:id/chi-tiet',
            component: './crm/city/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/quan-huyen',
            component: './crm/district',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/quan-huyen/tao-moi',
            component: './crm/district/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/quan-huyen/:id/chi-tiet',
            component: './crm/district/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          ...
          {
            path: '/crm/danh-muc/co-so/tao-moi',
            component: './crm/basis/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/co-so/:id/chi-tiet',
            component: './crm/basis/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/dang-ky-nhap-hoc',
            component: './crm/admission-registers',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/dang-ky-nhap-hoc/tao-moi',
            component: './crm/admission-registers/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/danh-muc/dang-ky-nhap-hoc/:id/chi-tiet',
            component: './crm/admission-registers/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          ...
          {
            path: '/crm/sale/ph-lead/tao-moi',
            component: './crm/sale-parents-lead/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/sale/ph-lead/:id/chi-tiet',
            component: './crm/sale-parents-lead/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/sale/ph-lead/:id/chi-tiet/them-lich-su',
          ...
          {
            path: '/crm/sale/ph-lead/:id/chi-tiet/gui-email',
            component: './crm/sale-parents-lead/create/add-email',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/sale/ph-lead/:id/chi-tiet/them-su-kien',
          ...
          {
            path: '/crm/sale/ph-tiem-nang/tao-moi',
            component: './crm/sale-parents-potential/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/sale/ph-tiem-nang/:id/chi-tiet',
            component: './crm/sale-parents-potential/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          ...
          {
            path: '/crm/tiep-thi/du-lieu/tao-moi',
          ...
          {
            path: '/crm/chinh-sach-phi/loai-lop',
            component: './crm/fee-policy/class-type',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/loai-lop/:id/chi-tiet',
            component: './crm/fee-policy/class-type/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sachh-phi/hinh-thuc-dong-phi',
            component: './crm/fee-policy/payment-method',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sachh-phi/hinh-thuc-dong-phi/:id/chi-tiet',
            component: './crm/fee-policy/payment-method/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/tinh-phi-hoc-sinh-moi',
            component: './crm/fee-policy/new-student',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/tinh-phi-hoc-sinh-moi/tao-moi',
            component: './crm/fee-policy/new-student/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/tinh-phi-hoc-sinh-moi/:id/chi-tiet',
            component: './crm/fee-policy/new-student/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/nam-hoc',
            component: './crm/fee-policy/school-year',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/nam-hoc/:id/chi-tiet',
            component: './crm/fee-policy/school-year/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/phi',
            component: './crm/fee-policy/fee',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/phi/:id/chi-tiet',
            component: './crm/fee-policy/fee/create',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
            path: '/crm/chinh-sach-phi/tien-dong',
            component: './crm/fee-policy/policy',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.CRM],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_KIENTHUCNUOIDAYTRE_DANHSACHBAIVIET_VIEW],
            authority: [],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_KIENTHUCNUOIDAYTRE_DANHMUC_VIEW],
          },
          {
      ...
      //CHILD'S DEVELOPMENT
      {
        ...
        routes: [
          {
            path: '/su-phat-trien-cua-tre',
            redirect: '/su-phat-trien-cua-tre/trang-chu',
          },
          {
            path: '/su-phat-trien-cua-tre/trang-chu',
            component: './waiting-page',
            wrappers: ['@/wrappers/auth'],
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [`${FLATFORM.WEB}${permissions.SPTCT_DANHMUC_KYNANG}${ACTION.VIEW}`],
          },
          {
            path: '/su-phat-trien-cua-tre/danh-muc/ky-nang/tao-moi',
            component: './child-develop/skill/add',
            wrappers: ['@/wrappers/auth'],
             authority: [`${FLATFORM.WEB}${permissions.SPTCT_DANHMUC_KYNANG}${ACTION.CREATE}`],
          },
          {
      ...
      // CURRENCY
      {
        ...
        routes: [
          ...
          {
            path: '/bieu-phi/bao-cao/cong-no-theo-doi-tuong',
            component: './currency/report/debt',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.BIEUPHI],
          },
          {
            path: '/bieu-phi/bao-cao/thu-chi-theo-doi-tuong',
            component: './currency/report/revenue-expenditure',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.BIEUPHI],
          },
          {
            path: '/bieu-phi/cau-hinh-noi-dung',
...

      {
        ...
        routes: [
          ...
          },
          {
            ...
            component: './english/settings/program',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYBAIGIANG_VIEW],
          },
          {
            path: '/english/settings/program/add',
            component: './english/settings/program/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYBAIGIANG_CREATE],
          },
          {
            path: '/english/settings/program/:id/detail',
            component: './english/settings/program/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYBAIGIANG_DETAIL],
          },
          {
            path: '/english/settings/program/:id/edit',
            component: './english/settings/program/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYBAIGIANG_EDIT],
          },
          {
            path: '/english/settings/cau-hinh',
            component: './english/settings/schedule',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_SCHEDULE_VIEW],
          },
          {
            path: '/english/settings/subject',
            component: './english/settings/subject',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_VIEW],
          },
          {
            path: '/english/settings/subject/add',
            component: './english/settings/subject/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_CREATE],
          },
          {
            path: '/english/settings/subject/:id/detail',
            component: './english/settings/subject/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_DETAIL],
          },
          {
            path: '/english/settings/subject/:id/edit',
            component: './english/settings/subject/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_EDIT],
          },
          {
            path: '/english/settings/evaluationCriteria',
            component: './english/settings/evaluation-criteria',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYTIEUCHI_VIEW],
          },
          {
            path: '/english/settings/evaluationCriteria/add',
            component: './english/settings/evaluation-criteria/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYTIEUCHI_CREATE],
          },
          {
            path: '/english/settings/evaluationCriteria/:id/detail',
            component: './english/settings/evaluation-criteria/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYTIEUCHI_DETAIL],
          },
          {
            path: '/english/settings/evaluationCriteria/:id/edit',
            component: './english/settings/evaluation-criteria/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYTIEUCHI_EDIT],
          },
          {
            path: '/english/settings/sampleComments',
            component: './english/settings/sample-comments',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYCOMMENT_VIEW],
          },
          {
            path: '/english/settings/sampleComments/add',
            component: './english/settings/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYCOMMENT_CREATE],
          },
          {
            path: '/english/settings/sampleComments/:id/detail',
            component: './english/settings/sample-comments/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYCOMMENT_DETAIL],
          },
          {
            path: '/english/settings/sampleComments/:id/edit',
            component: './english/settings/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYCOMMENT_EDIT],
          },
          {
            path: '/english/settings/scriptReview',
            component: './english/settings/script-review',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_KICHBANDANHGIA_VIEW],
          },
          {
            path: '/english/settings/scriptReview/add',
            component: './english/settings/script-review/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_KICHBANDANHGIA_CREATE],
          },
          {
            path: '/english/settings/scriptReview/:id/detail',
            component: './english/settings/script-review/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_KICHBANDANHGIA_DETAIL],
          },
          {
            path: '/english/settings/scriptReview/:id/edit',
            component: './english/settings/script-review/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_KICHBANDANHGIA_EDIT],
          },
          {
            path: '/english/quarter-report',
            component: './english/quarter-report',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_VIEW],
          },
          {
            path: '/english/quarter-report/:id/add',
            component: './english/quarter-report/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_CHUADANHGIA_CREATE],
          },
          {
            path: '/english/quarter-report/:id/detail',
            component: './english/quarter-report/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_VIEW],
          },
          {
            path: '/english/quarter-report/:id/confirmed',
            component: './english/quarter-report/confirmed',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_CHUADUYET_EDIT],
          },
          {
            path: '/english/quarter-report/:id/edit',
            component: './english/quarter-report/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_VIEW],
          },
          {
            path: '/english/monthly-report',
            component: './english/monthly-report',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIATHANG_VIEW],
          },
          {
          ...
          {
            path: '/english/monthly-report/:id/detail',
            component: './english/monthly-report/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIATHANG_VIEW],
          },
          {
            path: '/english/monthly-report/:id/edit',
            component: './english/monthly-report/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIATHANG_VIEW],
          },
          {
            path: '/english/monthly-report/:id/confirmed',
            component: './english/monthly-report/confirmed',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIATHANG_CHUADUYET_EDIT],
          },
          {
            path: '/english/study-plan',
            component: './english/study-plan',
            wrappers: ['@/wrappers/auth'],
      ...
      //PHYSICAL
      {
        ...
        routes: [
          ...
          },
          {
            ...
            component: './criteria/physical/lesson',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYBAIHOC_VIEW],
          },
          {
            path: '/the-chat/bai-hoc/add',
            component: './criteria/physical/lesson/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYBAIHOC_CREATE],
          },
          {
            path: '/the-chat/bai-hoc/:id/edit',
            component: './criteria/physical/lesson/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYBAIHOC_EDIT],
          },
          {
            path: '/the-chat/bai-hoc/:id/detail',
            component: './criteria/physical/lesson/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYBAIHOC_DETAIL],
          },
          {
            path: '/the-chat/nhan-xet-mau',
            component: './criteria/physical/sample-comments',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYNHANXET_VIEW],
          },
          {
            path: '/the-chat/nhan-xet-mau/add',
            component: './criteria/physical/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYNHANXET_CREATE],
          },
          {
            path: '/the-chat/nhan-xet-mau/:id/edit',
            component: './criteria/physical/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYNHANXET_EDIT],
          },
          {
            path: '/the-chat/nhan-xet-mau/:id/detail',
            component: './criteria/physical/sample-comments/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYNHANXET_DETAIL],
          },
          {
            path: '/the-chat/mon-danh-gia',
            component: './criteria/physical/subject-comments',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYMONDANHGIA_VIEW],
          },
          {
            path: '/the-chat/mon-danh-gia/add',
            component: './criteria/physical/subject-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYMONDANHGIA_CREATE],
          },
          {
            path: '/the-chat/mon-danh-gia/:id/edit',
            component: './criteria/physical/subject-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYMONDANHGIA_EDIT],
          },
          {
            path: '/the-chat/mon-danh-gia/:id/detail',
            component: './criteria/physical/subject-comments/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_QUANLYMONDANHGIA_DETAIL],
          },
          {
            path: '/the-chat/cau-hinh-danh-gia',
            component: './criteria/physical/configuration-reviews',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_CAUHINHDANHGIA_VIEW],
          },
          {
            path: '/the-chat/cau-hinh-danh-gia/add',
            component: './criteria/physical/configuration-reviews/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_CAUHINHDANHGIA_CREATE],
          },
          {
            path: '/the-chat/cau-hinh-danh-gia/:id/edit',
            component: './criteria/physical/configuration-reviews/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_CAUHINHDANHGIA_EDIT],
          },
          {
            path: '/the-chat/cau-hinh-danh-gia/:id/detail',
            component: './criteria/physical/configuration-reviews/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_CAUHINHDANHGIA_DETAIL],
          },
          {
            path: '/the-chat/nhan-xet-tiet-hoc',
            component: './criteria/physical/lesson-comments',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_NHANXETTIETHOC_VIEW],
          },
          {
            path: '/the-chat/nhan-xet-tiet-hoc/:id/add',
            component: './criteria/physical/lesson-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_NHANXETTIETHOC_VIEW],
          },
          {
            path: '/the-chat/nhan-xet-tiet-hoc/:id/detail',
            component: './criteria/physical/lesson-comments/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_NHANXETTIETHOC_VIEW],
          },
          {
            path: '/the-chat/do-luong-dinh-ky',
            component: './criteria/physical/periodic-measurement',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_DOLUONGDINHKY_VIEW],
          },
          {
            path: '/the-chat/do-luong-dinh-ky/:id/add',
            component: './criteria/physical/periodic-measurement/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_DOLUONGDINHKY_VIEW],
          },
          {
            path: '/the-chat/do-luong-dinh-ky/:id/detail',
            component: './criteria/physical/periodic-measurement/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_THECHAT_DOLUONGDINHKY_VIEW],
          },
          {
            path: '/the-chat/do-luong-dinh-ky/:id/confirmed',
