    ...
    routes: [
      ...
      // HRM
      {
        ...
        routes: [
          ...
          {
            path: '/quan-ly-nhan-su/khai-bao-cong',
            component: './hrm/work-declarations',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/quan-ly-nhan-su/khai-bao-cong/tao-moi',
            component: './hrm/work-declarations/add',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/quan-ly-nhan-su/cong-gio-ho-tro',
            component: './hrm/work-hours',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/quan-ly-nhan-su/cong-gio-ho-tro/tao-moi',
