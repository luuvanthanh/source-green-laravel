    ...
    routes: [
      ...
      // CRITERIA
      {
        ...
        routes: [
          ...
          {
            path: '/chuong-trinh-hoc/the-chat/bai-hoc',
            component: './criteria/physical/lesson',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/bai-hoc/add',
            component: './criteria/physical/lesson/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/bai-hoc/:id/edit',
            component: './criteria/physical/lesson/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/bai-hoc/:id/detail',
            component: './criteria/physical/lesson/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/nhan-xet-mau',
            component: './criteria/physical/sample-comments',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/nhan-xet-mau/add',
            component: './criteria/physical/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/nhan-xet-mau/:id/edit',
            component: './criteria/physical/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/nhan-xet-mau/:id/detail',
            component: './criteria/physical/sample-comments/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/mon-danh-gia',
            component: './criteria/physical/subject-comments',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/mon-danh-gia/add',
            component: './criteria/physical/subject-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/mon-danh-gia/:id/edit',
            component: './criteria/physical/subject-comments/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/mon-danh-gia/:id/detail',
            component: './criteria/physical/subject-comments/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/cau-hinh-danh-gia',
            component: './criteria/physical/configuration-reviews',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/cau-hinh-danh-gia/add',
            component: './criteria/physical/configuration-reviews/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/cau-hinh-danh-gia/:id/edit',
            component: './criteria/physical/configuration-reviews/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/cau-hinh-danh-gia/:id/detail',
            component: './criteria/physical/configuration-reviews/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.THECHAT],
          },
          {
            path: '/chuong-trinh-hoc/the-chat/nhan-xet-tiet-hoc',
