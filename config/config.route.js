...

      {
        ...
        routes: [
          ...
          },
          {
            ...
            component: './english/settings/program/add',
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_QUANLYBAIGIANG_UPDATE],
            authority: [permissions.CTH],
          },
          {
          ...
          },
          {
            ...
            component: './english/settings/subject/add',
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_UPDATE],
            authority: [permissions.CTH],
          },
          {
          ...
          },
          {
            ...
            component: './english/settings/evaluation-criteria/add',
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_QUANLYTIEUCHI_UPDATE],
            authority: [permissions.CTH],
          },
          {
          ...
          },
          {
            ...
            component: './english/settings/sample-comments/add',
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_QUANLYCOMMENT_UPDATE],
            authority: [permissions.CTH],
          },
          {
          ...
          },
          {
            ...
            component: './english/settings/script-review/add',
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_KICHBANDANHGIA_UPDATE],
            authority: [permissions.CTH],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_CHUADUYET_UPDATE],
            authority: [permissions.CTH],
          },
          {
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            // authority: [permissions.WEB_TIENGANH_DANHGIATHANG_CHUADUYET_UPDATE],
            authority: [permissions.CTH],
          },
          {
