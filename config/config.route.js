    ...
    routes: [
      ...
      // CONFIGURATION
      {
        ...
        routes: [
          ...
          {
            path: '/cau-hinh/co-so',
            component: './configuration/branches',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/cau-hinh/co-so/tao-moi',
            component: './configuration/branches/add',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/cau-hinh/co-so/:id/chi-tiet',
            component: './configuration/branches/add',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          ...
          {
            path: '/cau-hinh/tham-so-gia-tri',
            component: './configuration/paramater-values',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/cau-hinh/tham-so-gia-tri/tao-moi',
            component: './configuration/paramater-values/add',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/cau-hinh/tham-so-gia-tri/:id/chi-tiet',
            component: './configuration/paramater-values/add',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
