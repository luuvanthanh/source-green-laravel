    ...
    routes: [
      ...
      // CRITERIA
      {
        ...
        routes: [
          ...
          {
            path: '/chuong-trinh-hoc/settings/subject/add',
            component: './criteria/english/settings/subject/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_CREATE],
          },
          {
            path: '/chuong-trinh-hoc/settings/subject/:id/detail',
            component: './criteria/english/settings/subject/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_QUANLYPHANMUC_VIEW],
          },
          {
            path: '/chuong-trinh-hoc/settings/subject/:id/edit',
            component: './criteria/english/settings/subject/add',
            wrappers: ['@/wrappers/auth'],
          ...
          {
            path: '/chuong-trinh-hoc/quarter-report',
            component: './criteria/english/quarter-report',
            wrappers: ['@/wrappers/auth'],
          ...
          },
          {
            ...
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_CREATE],
          },
          {
            path: '/chuong-trinh-hoc/quarter-report/:id/detail',
            component: './criteria/english/quarter-report/detail',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_VIEW],
          },
          {
          ...
          },
          {
            ...
            component: './criteria/english/quarter-report/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIADINHKY_UPDATE],
          },
          {
          ...
          {
            path: '/chuong-trinh-hoc/monthly-report/:id/add',
            component: './criteria/english/monthly-report/add',
            wrappers: ['@/wrappers/auth'],
            authority: [],
          },
          {
            path: '/chuong-trinh-hoc/monthly-report/:id/detail',
          ...
          },
          {
            ...
            component: './criteria/english/monthly-report/add',
            wrappers: ['@/wrappers/auth'],
            authority: [permissions.WEB_TIENGANH_DANHGIATHANG_UPDATE],
          },
          {
