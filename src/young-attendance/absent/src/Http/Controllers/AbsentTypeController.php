...
use GGPHP\YoungAttendance\Absent\Http\Requests\AbsentTypeCreateRequest;
use GGPHP\YoungAttendance\Absent\Http\Requests\AbsentTypeUpdateRequest;
...
class AbsentTypeController extends Controller
{
    ...
    {
        $absentTypes = $this->absentTypeRepository->getAll($request->all());
