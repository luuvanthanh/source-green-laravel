...
namespace GGPHP\YoungAttendance\ShiftSchedule\Http\Controllers;

use GGPHP\Core\Http\Controllers\Controller;
use GGPHP\YoungAttendance\ShiftSchedule\Http\Requests\ActiveStatusShiftRequest;
use GGPHP\YoungAttendance\ShiftSchedule\Http\Requests\ShiftCreateRequest;
use GGPHP\YoungAttendance\ShiftSchedule\Http\Requests\ShiftDeleteRequest;
use GGPHP\YoungAttendance\ShiftSchedule\Http\Requests\ShiftUpdateRequest;
