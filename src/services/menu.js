...
export async function getLeftMenuHRM() {
  return [
    ...
    },
    {
      ...
      icon: 'icon icon-list',
      permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN}${ACTION.VIEW}`],
      children: [
        {
          ...
          permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHSACHPHONGVAN}${ACTION.VIEW}`],
          pro: true,
        },
        {
          title: 'Làm phỏng vấn',
          ...
          permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_LAMPHONGVAN}${ACTION.VIEW}`],
          pro: true,
        },
        {
          ...
          permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DUYETUNGVIEN}${ACTION.VIEW}`],
          pro: true,
        },
        {
          title: 'Danh mục',
          key: 'category',
      permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC}${ACTION.VIEW}`],
          children: [
            {
              title: 'Điểm đánh giá',
              key: 'point-evaluation',
              url: ['/quan-ly-nhan-su/quan-ly-phong-van/danh-muc/diem-danh-gia'],
              permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_DIEMDANHGIA}${ACTION.VIEW}`],
              pro: true,
            },
            {
              title: 'Tiêu chí đánh giá',
              ...
              permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_TIEUCHIDANHGIA}${ACTION.VIEW}`],
              pro: true,
            },
            {
              ...
              permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_NGUOIPHONGVAN}${ACTION.VIEW}`],
              pro: true,
            },
            {
              ...
              permission: [`${FLATFORM.WEB}${permissions.HRM_PHONGVAN_DANHMUC_CAUHINHPHONGVAN}${ACTION.VIEW}`],
              pro: true,
            },
          ],
          pro: true,
