...
const { confirm } = Modal;
const mapStateToProps = ({ children, loading }) => ({
  data: children.data,
...
class Index extends PureComponent {
  ...
  onFinish = () => {
    ...
    this.formRef.current.validateFields().then((values) => {
      this.props.dispatch({
        type: !isEmpty(objects) ? 'children/UPDATE' : 'children/ADD',
        payload: {
          ...values,
          id: objects.id,
        },
  ...
  header = () => {
    const columns = [
      ...
      },
      {
        ...
        render: (record) => <Text size="normal">Bông hoa nhỏ</Text>,
      },
      {
        title: 'GIỚI TÍNH',
        key: 'sex',
        className: 'min-width-150',
        render: (record) => <Text size="normal">Nam</Text>,
      },
      {
        title: 'NGÀY SINH',
        key: 'birthday',
  ...
  render() {
    ...
    const loading = effects['children/GET_DATA'];
    const loadingSubmit = effects['children/ADD'] || effects['children/UPDATE'];
    return (
      <>
        ...
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">DANH SÁCH HỌC SINH</Text>
