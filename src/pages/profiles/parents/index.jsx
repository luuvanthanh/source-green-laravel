...
const { confirm } = Modal;
const mapStateToProps = ({ parents, loading }) => ({
  data: parents.data,
...
class Index extends PureComponent {
  ...
  onFinish = () => {
    ...
    this.formRef.current.validateFields().then((values) => {
      this.props.dispatch({
        type: !isEmpty(objects) ? 'parents/UPDATE' : 'parents/ADD',
        payload: {
          ...values,
          id: objects.id,
        },
  ...
  render() {
    ...
    const loading = effects['parents/GET_DATA'];
    const loadingSubmit = effects['parents/ADD'] || effects['parents/UPDATE'];
    return (
      <>
        ...
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">DANH SÁCH PHỤ HUYNH</Text>
