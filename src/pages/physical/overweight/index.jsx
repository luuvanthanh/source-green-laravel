...
const Index = memo(() => {
  ...
  const [{ pagination, error, data }, loading] = useSelector(({ loading: { effects }, physicalStudentsOverweight }) => [
    physicalStudentsOverweight,
    effects,
  ]);
  ...
  useEffect(() => {
    dispatch({
      type: 'physicalStudentsOverweight/GET_DATA',
      payload: {
        ...search,
      },
    });
        ...
        <Pane className="card">
          <Pane className="p20">
            ...
            <Table
              ...
              columns={columns}
              dataSource={data}
              loading={loading['physicalStudentsOverweight/GET_DATA']}
