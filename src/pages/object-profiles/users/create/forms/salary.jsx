      ...
      >
        <Form layout="vertical" ref={formRefModal} initialValues={{}}>
          <Pane className="row">
            ...
            <Pane className="col-lg-6">
              <FormItem label="Mức lương (đ)" name="salary" type={variables.INPUT_NUMBER} />
            </Pane>
          </Pane>
          <Pane className="row">
            <Pane className="col-lg-6">
              <FormItem label="Hình thức chi trả" name="form" type={variables.SELECT} />
            </Pane>
            <Pane className="col-lg-6">
              <FormItem label="Trạng thái" name="status" type={variables.SELECT} />
            </Pane>
          </Pane>
        </Form>
      </Modal>
      ...
      >
        <Pane className="card">
          <Pane style={{ padding: 20 }} className="pb-0">
            <Heading type="form-title">Thông tin mức lương</Heading>
          </Pane>
          <Pane style={{ padding: 20 }} className="pb-0">
            <Table
              bordered
