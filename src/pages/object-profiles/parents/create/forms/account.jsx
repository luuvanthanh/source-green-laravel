            ...
            <Pane style={{ padding: 20 }} className="pb-0 border-bottom">
              ...
              <Pane className="row">
                <Pane className="col-lg-4">
                  <FormItem name="userName" label="Tên tài khoản" type={variables.INPUT} />
                </Pane>
                <Pane className="col-lg-4">
                  <FormItem name="email" label="Email" type={variables.INPUT} />
                </Pane>
                <Pane className="col-lg-4">
                  <FormItem name="password" label="Mật khẩu" type={variables.INPUT} />
                </Pane>
              </Pane>
              <hr />
              <Pane className="row">
                <Pane className="col-lg-4">
                  <FormItem data={[]} name="roleId" label="Vai trò" type={variables.SELECT} />
                </Pane>
              </Pane>
            </Pane>
