...
const mapStateToProps = ({ medicalStudentProblem, loading, user, OPThreeYear }) => ({
  loading,
  data: OPThreeYear.data,
...
class Index extends PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <Helmet title="Danh sách học sinh học trên 3 năm tính đến thời điểm" />
