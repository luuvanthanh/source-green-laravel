...
const mapStateToProps = ({ medicalStudentProblem, loading, user, OPFourYear }) => ({
  loading,
  data: OPFourYear.data,
...
class Index extends PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <Helmet title="Danh sách học sinh học trên 4 năm tính đến thời điểm" />
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Danh sách học sinh học trên 4 năm tính đến thời điểm</Text>
