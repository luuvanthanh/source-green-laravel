...
const mapStateToProps = ({ medicalStudentProblem, loading, user, OPListrecords }) => ({
  loading,
  data: OPListrecords.data,
...
class Index extends PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <Helmet title="Danh sách báo cáo học sinh rút hồ sơ" />
