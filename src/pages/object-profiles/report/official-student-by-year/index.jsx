        ...
        const columns = [
            ...
            },
            {
                ...
                render: (value, record) => {
                    ...
                    return <Text size="normal"> {Helper.getDate(record.registerDate, variables.DATE_FORMAT.DATE)}</Text>;
                },
            },
            {
            ...
            <>
                ...
                <div className={classnames(styles['content-form'], styles['content-form-children'])}>
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
                        <Text color="dark">Báo cáo thống kê số lượng học sinh nhập học chính thức theo năm</Text>
