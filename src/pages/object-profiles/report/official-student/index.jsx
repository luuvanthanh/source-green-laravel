...
const mapStateToProps = ({ medicalStudentProblem, loading, user, OPListOfficialStudent }) => ({
  loading,
  data: OPListOfficialStudent.data,
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'OPListOfficialStudent/GET_DATA',
      payload: {
        ...search,
      },
    });
  ...
  render() {
    ...
    return (
      <>
        <Helmet title="Danh sách báo cáo học sinh nhập học chính thức" />
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Danh sách báo cáo học sinh nhập học chính thức</Text>
