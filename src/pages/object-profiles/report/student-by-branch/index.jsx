...
const mapStateToProps = ({ medicalStudentProblem, loading, user, OPStudentByBranch }) => ({
  loading,
  data: OPStudentByBranch.data,
        ...
        children: [
          {
            ...
            key: 'height?.value',
            width: 150,
            render: (value, record) => <Text size="normal">{record?.height?.value}</Text>,
          },
          {
            title: 'Cân nặng',
            key: 'weight?.value',
  ...
  onChangeExcel = () => {
    ...
    Helper.exportExcelClover(
      `/students/export-to-excel/group-by-branch`,
      {
        ...
        SearchDate: moment(dataIDSearch).format(variables.DATE_FORMAT.DATE_AFTER),
      },
      `Danhsachbaocaoquantrihocsinh.xlsx`,
    );
  };
      ...
      <>
        ...
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Danh sách báo cáo quản trị học sinh</Text>
