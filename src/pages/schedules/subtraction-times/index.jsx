...
const { confirm } = Modal;
const mapStateToProps = ({ subtractionTimes, loading }) => ({
  data: subtractionTimes.data,
  pagination: subtractionTimes.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'subtractionTimes/GET_DATA',
      payload: {
        ...search,
        status,
      },
  ...
  header = () => {
    ...
    return [
      ...
      },
      {
        ...
        render: (record) => Helper.getDate(record?.created_at, variables.DATE_FORMAT.DATE_AFTER),
      },
      {
        title: 'Số ngày công',
        key: 'days',
        ...
        width: 130,
        render: (record) => get(record, 'subtractionTimeDetail[0].days'),
      },
      {
        title: 'Số giờ công',
        key: 'hours',
        ...
        className: 'min-width-130',
        width: 130,
        render: (record) => get(record, 'subtractionTimeDetail[0].hours'),
      },
      {
        title: 'Lý do',
        key: 'reason',
        ...
        render: (record) => (
          ...
          >
            {get(record, 'subtractionTimeDetail[0].reason')}
          </Paragraph>
        ),
      },
      {
  ...
  render() {
    ...
    const loading = effects['subtractionTimes/GET_DATA'];
    return (
      <>
