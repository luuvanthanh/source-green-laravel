...
const { confirm } = Modal;
const mapStateToProps = ({ additionalTimes, loading }) => ({
  data: additionalTimes.data,
  pagination: additionalTimes.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['additionalTimes/GET_DATA'];
    return (
      <>
        <Helmet title="Danh sách công thêm" />
        <div className={classnames(styles['content-form'], styles['content-form-additionalTimes'])}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Danh sách công thêm</Text>
