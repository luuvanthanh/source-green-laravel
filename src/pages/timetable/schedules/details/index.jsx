...
const Index = memo(({ loading: { effects }, match: { params }, error, menuLeft, details }) => {
              ...
              <Pane className="card" style={{ padding: 20 }}>
                ...
                <Pane className={csx('row', 'border-bottom', 'pb20', 'pt20')}>
                  <Pane className="col-lg-6">
                    ...
                    <p className="font-weight-bold">
                      {details?.eventType
                        ? variablesModules.TYPE_CALENDAR.find(
                            (item) => item.id === details?.eventType,
                          )?.name
                        : ''}
                    </p>
                  </Pane>
                ...
                <Pane className={csx('row', 'border-bottom', 'pb20', 'pt20')}>
                  <Pane className="col-lg-6">
                    ...
                    <p className="font-weight-bold">
                      ...
                      )} - ${Helper.getDateSearch(details?.endTime, variables.DATE_FORMAT.HOUR)}`}
                    </p>
                  </Pane>
                  {details?.isReminded && (
                    <>
                ...
                <Pane className={csx('row', 'border-bottom', 'pb20', 'pt20')}>
                  <Pane className="col-lg-12">
                    ...
                    {!isEmpty(details?.parentTimetables) &&
                      details?.parentTimetables?.map((item, index) => (
                        <div key={index}>
                          <Pane
                            key={index}
                    ...
                    <div className="mb20 mt15">
                      ...
                      <p className="mt10 mb0">
                        ...
                        <span className="font-weight-bold">
                          {Helper.getDate(details.creationTime, variables.DATE_FORMAT.TIME_DATE_VI)}
                        </span>
                      </p>
                    </div>
                  </Pane>
