...
class Index extends PureComponent {
  ...
  onFinish = (values) => {
    ...
    dispatch({
      ...
      payload: {
        ...
        type: variablesModules?.STATUS_TYPE_DECISION?.TRANSFER,
  ...
  onChangeNumber = (e) => {
    ...
    dispatch({
      ...
      payload: { decisionDate: moment(e).format(variables.DATE_FORMAT.DATE_AFTER), type: variablesModules?.STATUS_TYPE_DECISION?.TRANSFER },
      callback: (response) => {
        this.setStateData({
      ...
      <>
        ...
        >
          <div className={styles['content-form']}>
            <Loading loading={loading} isError={error.isError} params={{ error, goBack: '/quan-ly-nhan-su/dieu-chuyen' }}>
