...
const mapStateToProps = ({ transfers, loading }) => ({
  data: transfers.data,
...
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['transfers/GET_DATA'];
    return (
      <>
        <Helmet title="Danh sách điều chuyển" />
        <div className={classnames(styles['content-form'], styles['content-form-transfers'])}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Danh sách điều chuyển</Text>
