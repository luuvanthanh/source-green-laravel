...
const mapStateToProps = ({ absentReasons, loading }) => ({
  data: absentReasons.data,
  pagination: absentReasons.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['absentReasons/GET_DATA'];
    return (
      <>
        <Helmet title="Danh sách lý do nghỉ phép" />
        <div className={classnames(styles['content-form'], styles['content-form-absentReasons'])}>
          {/* FORM SEARCH */}
