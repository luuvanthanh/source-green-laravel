...
const mapStateToProps = ({ businessCards, loading }) => ({
  ...
  employees: businessCards.employees,
  loading,
});
...
class Index extends PureComponent {
  ...
  loadCategories = () => {
    ...
    dispatch({
      type: 'businessCards/GET_EMPLOYEES',
      payload: {},
    });
  };
  ...
  render() {
    ...
    return (
      <>
        <Helmet title="Phiếu đi công tác/ đi ra ngoài" />
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Phiếu đi công tác/ đi ra ngoài</Text>
