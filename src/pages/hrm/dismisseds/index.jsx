...
const mapStateToProps = ({ dismisseds, loading }) => ({
  data: dismisseds.data,
  pagination: dismisseds.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  export = (id) => {
    Helper.exportExcel(`/v1/dismisseds-export-word/${id}`, {}, 'QDMienNhiem.docx');
  };
  ...
  render() {
    ...
    const loading = effects['dismisseds/GET_DATA'];
    return (
      <>
        <Helmet title="Danh sách miễn nhiệm" />
        <div className={classnames(styles['content-form'], styles['content-form-dismisseds'])}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Danh sách miễn nhiệm</Text>
