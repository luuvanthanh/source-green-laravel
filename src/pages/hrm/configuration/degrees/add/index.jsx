...
class Index extends PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <Breadcrumbs last={params.id ? 'Chỉnh sửa bằng cấp' : 'Tạo bằng cấp'} menu={menuData} />
        <Form
        ...
        >
          <Loading loading={loading} isError={error.isError} params={{ error, goBack: '/quan-ly-nhan-su/cau-hinh/bang-cap' }}>
