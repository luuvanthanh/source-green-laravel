...
class Index extends PureComponent {
  ...
  componentDidMount() {
    ...
    if (params.id) {
      dispatch({
        type: 'trainingMajorsAdd/GET_DETAILS',
        payload: params,
      });
    }
  }
  ...
  onFinish = (values) => {
    ...
    dispatch({
      type: params.id ? 'trainingMajorsAdd/UPDATE' : 'trainingMajorsAdd/ADD',
      payload,
  ...
  render() {
    ...
    return (
      <>
        <Breadcrumbs
          last={params.id ? 'Chỉnh sửa chuyên ngành đào tạo' : 'Tạo chuyên ngành đào tạo'}
          menu={menuData}
        />
        <Form
        ...
        >
          <Loading loading={loading} isError={error.isError} params={{ error, goBack: '/quan-ly-nhan-su/cau-hinh/nganh-dao-tao' }}>
