...
const mapStateToProps = ({ educationalLevels, loading }) => ({
  data: educationalLevels.data,
  error: educationalLevels.error,
  pagination: educationalLevels.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'educationalLevels/GET_DATA',
      payload: {
        ...search,
      },
    });
