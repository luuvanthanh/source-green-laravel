...
const mapStateToProps = ({ typeOfContracts, loading }) => ({
  data: typeOfContracts.data,
  error: typeOfContracts.error,
  pagination: typeOfContracts.pagination,
  loading,
});
