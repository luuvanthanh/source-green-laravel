...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmInterviewManagerCategoryEvaluationCriteria = {} }) => [
    loading,
    hrmInterviewManagerCategoryEvaluationCriteria?.paginationReducer,
    hrmInterviewManagerCategoryEvaluationCriteria?.data,
  ]);
  const loading = loadingReducer?.effects['hrmInterviewManagerCategoryEvaluationCriteria/GET_DATA'];
