...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmRecruitmentBrowseCandidates = {} }) => [
    loading,
    hrmRecruitmentBrowseCandidates?.paginationReducer,
    hrmRecruitmentBrowseCandidates?.data,
  ]);
  const loading = loadingReducer?.effects['hrmRecruitmentBrowseCandidates/GET_DATA'];
  ...
  const loadData = useCallback(() => {
    dispatch({
      type: 'hrmRecruitmentBrowseCandidates/GET_DATA',
      payload: {
        ...search,
      },
    });
    ...
    <>
      ...
      <Pane className={csx(styles['content-form'], styles['content-form-children'])}>
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Text color="dark">Duyệt ứng viên</Text>
        </div>
        <Pane className="card">
