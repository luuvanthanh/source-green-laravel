...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmRecruitmentInterviewList = {} }) => [
    loading,
    hrmRecruitmentInterviewList?.paginationReducer,
    hrmRecruitmentInterviewList?.data,
  ]);
  const loading = loadingReducer?.effects['hrmRecruitmentInterviewList/GET_DATA'];
  ...
  const loadData = useCallback(() => {
    dispatch({
      type: 'hrmRecruitmentInterviewList/GET_DATA',
      payload: {
        ...search,
      },
    });
