...
class Index extends PureComponent {
  ...
  render() {
    ...
    const loadingSubmit = effects['sabbaticalLeavesAdd/ADD'] || effects['sabbaticalLeavesAdd/UPDATE'];
    return (
      <>
        <Breadcrumbs
          last={params.id ? 'Chỉnh sửa ngày nghỉ phép của nhân viên' : 'Tạo ngày nghỉ phép của nhân viên'}
          menu={menuData}
        />
        <Form
