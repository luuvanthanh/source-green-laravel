...
const mapStateToProps = ({ salaryIncreases, loading }) => ({
  data: salaryIncreases.data,
  pagination: salaryIncreases.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  export = (id) => {
    Helper.exportExcel(`/v1/salary-increases-export-word/${id}`, {}, 'QD-TangLuong.docx');
  };
  ...
  render() {
    ...
    const loading = effects['salaryIncreases/GET_DATA'];
    return (
      <>
        <Helmet title="Danh sách tăng lương" />
        <div className={classnames(styles['content-form'], styles['content-form-salaryIncreases'])}>
          {/* FORM SEARCH */}
