...
const mapStateToProps = ({ HRMContractModelNumber, loading }) => ({
  data: HRMContractModelNumber.data,
  error: HRMContractModelNumber.error,
  pagination: HRMContractModelNumber.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'HRMContractModelNumber/GET_DATA',
      payload: {
        ...search,
      },
    });
 ...
 */
  ...
  render() {
    ...
    const { search } = this.state;
    const loading = effects['HRMContractModelNumber/GET_DATA'];
    return (
      <>
        <Helmet title="Khai báo mẫu số hợp đồng" />
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">Khai báo mẫu số hợp đồng</Text>
