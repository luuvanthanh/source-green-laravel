...
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading =
      effects['laboursContractsAdd/GET_CATEGORIES'] || effects['laboursContractsAdd/GET_DETAILS'];
    const loadingSubmit = effects['laboursContractsAdd/ADD'] || effects['laboursContractsAdd/UPDATE'];
    return (
      <>
        <Breadcrumbs
