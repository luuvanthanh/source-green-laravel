...
const { confirm } = Modal;
const mapStateToProps = ({ insurrances, loading }) => ({
  data: insurrances.data,
  pagination: insurrances.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  header = () => {
    ...
    return [
      ...
      },
      {
        ...
        width: 100,
        render: (record) => get(record, 'insurranceNumber'),
      },
      {
        title: 'Ngày tham gia',
        key: 'timeJoin',
        ...
        width: 120,
        render: (record) => Helper.getDate(get(record, 'timeJoin'), variables.DATE_FORMAT.DATE),
      },
      {
        title: 'Ngày bắt đầu',
        key: 'timeStart',
  ...
  render() {
    ...
    const loading = effects['insurrances/GET_DATA'];
    return (
      <>
        <Helmet title="Danh sách bảo hiểm xã hội" />
        <div className={classnames(styles['content-form'], styles['content-form-insurrances'])}>
          {/* FORM SEARCH */}
