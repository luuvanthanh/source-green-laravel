...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmProbationManagerProbationaryAssessmentList = {} }) => [
    loading,
    hrmProbationManagerProbationaryAssessmentList?.paginationReducer,
    hrmProbationManagerProbationaryAssessmentList?.data,
  ]);
  const loading = loadingReducer?.effects['hrmProbationManagerProbationaryAssessmentList/GET_DATA'];
  ...
  const loadData = useCallback(() => {
    dispatch({
      type: 'hrmProbationManagerProbationaryAssessmentList/GET_DATA',
      payload: {
        ...search,
      },
    });
  ...
  const onRemove = (id) => {
    ...
    Helper.confirmDelete({
      callback: () => {
        dispatch({
          type: 'hrmProbationManagerProbationaryAssessmentList/REMOVE',
          payload: {
            id,
          },
          callback: (response) => {
  ...
  return (
    <>
      <Helmet title="Danh sách đánh giá thử việc" />
      <Pane className={csx(styles['content-form'], styles['content-form-children'])}>
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Text color="dark">Danh sách đánh giá thử việc</Text>
