...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmProbationManagerProbationaryAssessment = {} }) => [
    loading,
    hrmProbationManagerProbationaryAssessment?.paginationReducer,
    hrmProbationManagerProbationaryAssessment?.data,
  ]);
  const loading = loadingReducer?.effects['hrmProbationManagerProbationaryAssessment/GET_DATA'];
  ...
  const loadData = useCallback(() => {
    dispatch({
      type: 'hrmProbationManagerProbationaryAssessment/GET_DATA',
      payload: {
        ...search,
      },
    });
      ...
      render: (record) => (
        <div className={styles['list-button']}>
          <Button color="success" onClick={(e) => {
            e.stopPropagation();
            history.push(`${pathname}/${record?.id}/danh-gia`);
          }}>
            Đánh giá
          </Button>
        </div>
