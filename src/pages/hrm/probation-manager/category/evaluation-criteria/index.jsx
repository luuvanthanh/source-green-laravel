...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmProbationManagerCategoryEvaluationCriteria = {} }) => [
    loading,
    hrmProbationManagerCategoryEvaluationCriteria?.paginationReducer,
    hrmProbationManagerCategoryEvaluationCriteria?.data,
  ]);
  const loading = loadingReducer?.effects['hrmProbationManagerCategoryEvaluationCriteria/GET_DATA'];
  ...
  const loadData = useCallback(() => {
    dispatch({
      type: 'hrmProbationManagerCategoryEvaluationCriteria/GET_DATA',
      payload: {
        ...search,
      },
    });
  ...
  const onRemove = (id) => {
    ...
    Helper.confirmDelete({
      callback: () => {
        dispatch({
          type: 'hrmProbationManagerCategoryEvaluationCriteria/REMOVE',
          payload: {
            id,
          },
          callback: (response) => {
