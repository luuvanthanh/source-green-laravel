...
const Index = memo(() => {
  const [
    ...
    paginationReducer,
    data,
  ] = useSelector(({ loading, hrmProbationManagerBrowseProbationaryPersonnel = {} }) => [
    loading,
    hrmProbationManagerBrowseProbationaryPersonnel?.paginationReducer,
    hrmProbationManagerBrowseProbationaryPersonnel?.data,
  ]);
  const loading = loadingReducer?.effects['hrmProbationManagerBrowseProbationaryPersonnel/GET_DATA'];
    ...
    <>
      ...
      <Pane className={csx(styles['content-form'], styles['content-form-children'])}>
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Text color="dark">Duyệt nhân sự thử việc</Text>
        </div>
        <Pane className="card">
