...
const mapStateToProps = ({ currencyNewStudent, loading }) => ({
  data: currencyNewStudent.data,
  error: currencyNewStudent.error,
  pagination: currencyNewStudent.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'currencyNewStudent/GET_DATA',
      payload: {
        ...search,
  ...
  header = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'basic',
        className: 'min-width-200',
        render: (record) => record?.dayAdmission || '',
      },
      {
        title: 'Họ tên cha',
        key: 'Grade',
      ...
      },
      {
        ...
        render: (record) => record?.fatherPhone || '',
      },
      {
        title: 'Họ tên mẹ',
        key: 'year',
        className: 'min-width-200',
        render: (record) => record?.monName || '',
      },
      {
        title: 'SĐT mẹ',
        key: 'detail',
        className: 'min-width-130',
        render: (record) => record?.monPhone || ''
      },
      {
  ...
  render() {
    ...
    const { search } = this.state;
    const loading = effects['currencyNewStudent/GET_DATA'];
    return (
      <>
