...
const mapStateToProps = ({ currencyDebt, loading }) => ({
  data: currencyDebt.data,
  error: currencyDebt.error,
  pagination: currencyDebt.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  render() {
    ...
    const { search } = this.state;
    const loading = effects['currencyDebt/GET_DATA'];
    return (
      <>
        <Helmet title="TỔNG HỢP CÔNG NỢ THEO ĐỐI TƯỢNG" />
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">TỔNG HỢP CÔNG NỢ THEO ĐỐI TƯỢNG</Text>
          </div>
