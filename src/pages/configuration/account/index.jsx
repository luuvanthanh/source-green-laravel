...
class Index extends PureComponent {
  ...
  onFinish = () => {
    ...
    this.formRef.current.validateFields().then((values) => {
      this.props.dispatch({
        type: !isEmpty(objects) ? 'configurationAccount/UPDATE' : 'configurationAccount/ADD',
        payload: {
          ...values,
          id: objects.id,
        },
  ...
  onChangeSwitch = (record, checked) => {
    ...
    dispatch({
      type: 'configurationAccount/UPDATE_CONFIG',
      payload: {
        ...record,
  ...
  header = () => {
    ...
    return [
      ...
      },
      {
        ...
        render: (record) => record.shift_code,
      },
      {
        title: 'Thời gian',
        key: 'time',
        ...
        >
          ...
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            ...
            <Button
              color="success"
              icon="plus"
              onClick={() => history.push(`/diem-danh/cau-hinh/tao-moi`)}
            >
              Tạo ca
            </Button>
          </div>
