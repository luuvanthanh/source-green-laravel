...
class Index extends PureComponent {
  ...
  onFinish = (values) => {
    ...
    if (params.id) {
      dispatch({
        type: 'educationalLevelsAdd/UPDATE',
        payload: {
          ...values,
          id: params.id,
        },
  ...
  render() {
    ...
    const loadingSubmit = effects['educationalLevelsAdd/ADD'] || effects['educationalLevelsAdd/UPDATE'];
    const loading = effects['educationalLevelsAdd/GET_DETAILS'];
    return (
      <>
        <Breadcrumbs last="Tạo trình độ học vấn" menu={menuConfiguration} />
        <Form
          ...
          <Loading loading={loading} isError={error.isError} params={{ error }}>
            <div className={styles['content-form']}>
              <div className="d-flex justify-content-between">
                <Text color="dark">TẠO MỚI TRÌNH ĐỘ HỌC VẤN</Text>
              </div>
