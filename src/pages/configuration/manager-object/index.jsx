...
const mapStateToProps = ({ managerObject, loading }) => ({
  data: managerObject.data,
  error: managerObject.error,
  pagination: managerObject.pagination,
  loading,
});
      ...
      },
      {
        ...
        render: (record) => (
          <div className={styles['list-button']}>
            <Button
              color="success"
              onClick={() => history.push(`/cau-hinh/nhom-doi-tuong/${record?.id}/chi-tiet`)}
            >
              Chi tiết
            </Button>
          </div>
      ...
      <>
        ...
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">Nhóm đối tượng</Text>
