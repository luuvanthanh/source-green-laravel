...
const mapStateToProps = ({ allocationRegister, loading, user }) => ({
  loading,
  data: allocationRegister.data,
  error: allocationRegister.error,
  classes: allocationRegister.classes,
  branches: allocationRegister.branches,
  pagination: allocationRegister.pagination,
...
class Index extends PureComponent {
  ...
  header = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'classTypes',
        width: 200,
        render: (record) => <Text size="normal">{record?.classTypes}</Text>,
      },
      {
        title: 'Lớp',
        key: 'class',
      ...
      },
      {
        ...
        render: (record) => (
          <Text size="normal">
            {Helper.getDate(record?.date, variables.DATE_FORMAT.DATE_TIME)}
          </Text>
        ),
      },
      {
  ...
  render() {
    ...
    const loading = effects['allocationRegister/GET_DATA'];
    return (
      <>
        <Helmet title="Đăng ký học ngoài giờ" />
        <div className={classnames(styles['content-form'], styles['content-form-children'], 'mt8')}>
          {/* FORM SEARCH */}
          <div className="d-flex justify-content-between align-items-center mt-3 mb-3">
            <Text color="dark">Đăng ký học ngoài giờ</Text>
          </div>
