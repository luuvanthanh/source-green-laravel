    ...
    const columns = [
      {
        ...
        render: (value, record) => {
          ...
          return <Text size="normal">{record.code}</Text>;
        },
      },
      {
        title: 'Tên giáo viên',
        ...
        render: (value, record) =>
          <Text size="normal">{record?.nameTeacher}</Text>
      },
      {
        title: 'Cơ sở',
        key: 'birthDay',
        width: 250,
        className: 'min-width-250',
        render: (value, record) => <Text size="normal"> {record?.branch}</Text>
      },
      {
        title: 'Lớp',
        key: 'birthDay',
        ...
        className: 'min-width-250',
        render: (value, record) =>
          <Text size="normal"> {record?.class}</Text>
      },
      {
        title: 'Ngày vào lớp',
        width: 250,
