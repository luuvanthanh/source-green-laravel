...
const Index = memo(() => {
  const [loadingReducer, paginationReducer] = useSelector(({ loading, health = {} }) => [loading, health?.pagination])
    ...
    <>
      ...
      <Pane className="p20">
        <Pane className="d-flex mb20">
          <Heading type="page-title">Sức khỏe hôm nay - Ngày {moment().format(variables.DATE_FORMAT.DATE_VI)}</Heading>
        </Pane>
        <Pane className="card">
          <Pane className="p20">
            <Form
