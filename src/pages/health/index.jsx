...
const Index = memo(() => {
  const [loadingReducer, paginationReducer] = useSelector(({ loading, health = {} }) => [
    loading,
    health?.pagination,
  ]);
  const loading = loadingReducer?.effects['health/GET_DATA'];
      ...
      <Pane className="p20">
        <Pane className="d-flex justify-content-between align-items-center mb20">
          <Heading type="page-title">
            Sức khỏe hôm nay - Ngày {moment().format(variables.DATE_FORMAT.DATE_VI)}
          </Heading>
          ...
          <Pane className="p20">
            <Form layout="vertical" ref={filterRef}>
              <Pane className="row">
                ...
                <Pane className="col-lg-3">
                  <FormItem name="branch" type={variables.SELECT} />
                </Pane>
                <Pane className="col-lg-3">
                  <FormItem name="class" type={variables.SELECT} />
                </Pane>
              </Pane>
            </Form>
