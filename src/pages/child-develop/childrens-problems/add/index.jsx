...
class Index extends PureComponent {
  ...
  cancel = (id) => {
    ...
    return Helper.confirmAction({
      callback: () => {
        dispatch({
          type: 'childDevelopChildProblemsAdd/REMOVE',
          payload: {
            id,
          },
          callback: (response) => {
  ...
  componentDidMount() {
    ...
    if (params.id) {
      dispatch({
        type: 'childDevelopChildProblemsAdd/GET_DETAILS',
        payload: params,
      });
    }
    dispatch({
  ...
  onFinish = (values) => {
    ...
    dispatch({
      type: params.id ? 'childDevelopChildProblemsAdd/UPDATE' : 'childDevelopChildProblemsAdd/ADD',
      payload,
  ...
  render() {
    ...
    const loadingSubmit =
      effects['childDevelopChildProblemsAdd/ADD'] || effects['childDevelopChildProblemsAdd/UPDATE'];
    const loading = effects['childDevelopChildProblemsAdd/GET_DETAILS'];
    return (
      <>
                  ...
                  <Pane className="card">
                    ...
                    <Pane className="p20 d-flex justify-content-between align-items-center border-top">
                      ...
                      <Button
                        ...
                        permission={
                          params?.id
                            ? `${FLATFORM.WEB}${permissions.SPTCT_DANHMUC_VANDEKHOKHAN}${ACTION.EDIT}`
                            : `${FLATFORM.WEB}${permissions.SPTCT_DANHMUC_VANDEKHOKHAN}${ACTION.CREATE}`
                        }
                      >
                        Lưu
                      </Button>
