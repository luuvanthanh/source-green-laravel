  ...
  header = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: 150,
        render: (value, record) => (
          <div className="d-flex">{record.classStudent?.class?.branch?.name}</div>
        ),
      },
      {
        title: 'Lớp',
        key: 'class',
        width: 150,
        render: (value, record) => <div className="d-flex">{record?.classes?.name}</div>,
      },
      {
        title: 'Ngày vào lớp',
        key: 'time',
        ...
        render: (record) => (
          <div className={styles['list-button']}>
            <Button
              ...
              permission={`${FLATFORM.WEB}${permissions.SPTCT_THEODOISPT}${ACTION.DETAIL}`}
            >
              Chi tiết
            </Button>
          </div>
