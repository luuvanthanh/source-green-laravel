...
const { confirm } = Modal;
const mapStateToProps = ({ branch, loading }) => ({
  data: branch.data,
...
class Index extends PureComponent {
  ...
  onFinish = () => {
    ...
    this.formRef.current.validateFields().then((values) => {
      this.props.dispatch({
        type: !isEmpty(objects) ? 'branch/UPDATE' : 'branch/ADD',
        payload: {
          ...values,
          id: objects.id,
        },
  ...
  header = () => {
    const columns = [
      ...
      },
      {
        ...
        render: (record) => <Text size="normal">CS01</Text>,
      },
      {
        title: 'TÊN CƠ SỞ',
        key: 'name',
      ...
      },
      {
        ...
        key: 'address',
        className: 'min-width-150',
        render: (record) => <Text size="normal">169 - 171 Đường số 5, Phường An Phú, Quận 2</Text>,
      },
      {
        key: 'action',
  ...
  render() {
    ...
    const loading = effects['branch/GET_DATA'];
    const loadingSubmit = effects['branch/ADD'] || effects['branch/UPDATE'];
    return (
      <>
        ...
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">DANH SÁCH CHUỖI CƠ SỞ</Text>
