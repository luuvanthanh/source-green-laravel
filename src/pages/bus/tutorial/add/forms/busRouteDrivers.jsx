        ...
        <Loading loading={loading} isError={error.isError} params={{ error, type: 'container' }}>
          <div className="card">
            <div style={{ padding: 20 }} className="pb-0 border-bottom">
              <Heading type="form-title">Thông tin lái xe</Heading>
              <Form.List name="busRouteDrivers">
                {(fields, { add, remove }) => (
                  <div>
                    <Scrollbars
                      autoHeight
                        ...
                        {fields.map((field, index) => (
                          <div key={index}>
                            <div className="d-flex justify-content-between align-items-center pr10">
                              <Heading type="form-block-title">LÁI XE {index + 1}</Heading>
                              {fields?.length > 1 && (
                                <button
                                  type="button"
                    ...
                    >
                      <span className="icon-plus-circle" /> THÊM THÔNG TIN LÁI XE
                    </p>
                  </div>
                )}
              </Form.List>
