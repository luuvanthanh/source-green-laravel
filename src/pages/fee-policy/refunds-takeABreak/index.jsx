...
const mapStateToProps = ({ feePolicyRefundstakeABreak, loading }) => ({
  data: feePolicyRefundstakeABreak.data,
  error: feePolicyRefundstakeABreak.error,
  pagination: feePolicyRefundstakeABreak.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'feePolicyRefundstakeABreak/GET_DATA',
      payload: {
        ...search,
  ...
  render() {
    ...
    return (
      <>
        <Helmet title="Danh sách hoàn phí học sinh tạm nghỉ" />
