...
const mapStateToProps = ({ feePolicyConfiguration, loading }) => ({
  data: feePolicyConfiguration.data,
  error: feePolicyConfiguration.error,
  pagination: feePolicyConfiguration.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'feePolicyConfiguration/GET_DATA',
      payload: {
        ...search,
  ...
  render() {
    ...
    const { search } = this.state;
    const loading = effects['feePolicyConfiguration/GET_DATA'];
    return (
      <>
        <Helmet title="Cấu hình hoàn phí" />
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">Cấu hình hoàn phí</Text>
            <Button
              color="success"
              icon="plus"
