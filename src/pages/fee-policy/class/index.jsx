...
const Index = memo(() => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record) => <Text size="normal">Lớp dành cho trẻ từ 15 - 24 tháng tuổi</Text>,
    },
    {
      key: 'action',
      ...
      render: (record) => (
        <div className={styles['list-button']}>
          <Button
            color="success"
            ghost
            onClick={() => history.push(`/chinh-sach-phi/lop/${record?.id}/chi-tiet`)}
          >
            Chi tiết
          </Button>
        </div>
      ...
      <Pane className="p20">
        <Pane className="d-flex mb20">
          ...
          <Button
            ...
            color="success"
            icon="plus"
            onClick={() => history.push(`/chinh-sach-phi/lop/tao-moi`)}
          >
            Tạo mới
          </Button>
        </Pane>
