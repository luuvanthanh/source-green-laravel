...
const mapStateToProps = ({ menu, loading, crmParentsPotentialAdd }) => ({
  loading,
  menuData: menu.menuLeftCRM,
  details: crmParentsPotentialAdd.details,
  error: crmParentsPotentialAdd.error,
  paramaterValues: crmParentsPotentialAdd.paramaterValues,
});
...
class Index extends PureComponent {
  ...
  cancel = (id) => {
    ...
    return Helper.confirmAction({
      callback: () => {
        dispatch({
          type: 'crmParentsPotentialAdd/REMOVE',
          payload: {
            id,
          },
          callback: (response) => {
  ...
  componentDidMount() {
    ...
    if (params.id) {
      dispatch({
        type: 'crmParentsPotentialAdd/GET_DETAILS',
        payload: params,
      });
    }
  }
  ...
  onFinish = (values) => {
    ...
    dispatch({
      type: params.id ? 'crmParentsPotentialAdd/UPDATE' : 'crmParentsPotentialAdd/ADD',
      payload,
  ...
  render() {
    ...
    const loadingSubmit =
      effects['crmParentsPotentialAdd/ADD'] || effects['crmParentsPotentialAdd/UPDATE'];
    const loading = effects['crmParentsPotentialAdd/GET_DETAILS'];
    return (
      <>
