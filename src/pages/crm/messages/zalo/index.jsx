...
const Index = memo(() => {
  ...
  const [{ user, pages }, loading] = useSelector(({ crmZalo, loading: { effects } }) => [
    crmZalo,
    effects,
  ]);
  ...
  useEffect(() => {
    if (pageCurrent?.id) {
      dispatch({
        type: 'crmZalo/GET_CONVERSATIONS',
        payload: {
      ...
      <div className={styles['wrapper-container']}>
        ...
        <div className={styles['sidebar-container']}>
          ...
          <div className={styles['user-container']}>
            ...
            >
              <div>
                {loading['crmZalo/GET_PAGES'] ||
                  (loading['crmZalo/GET_CONVERSATIONS'] && (
                    <>
                ...
                {(!loading['crmZalo/GET_PAGES'] || !loading['crmZalo/GET_CONVERSATIONS']) &&
