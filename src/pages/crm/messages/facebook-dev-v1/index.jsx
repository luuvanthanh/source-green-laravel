...
const Index = memo(() => {
  ...
  // Get data login từ localStorage  
  useEffect(() => {
  ...
  // lấy value ô input khi nhập tin nhắn 
  ...
  // hàm khi nhấn enter của ô input tin nhắn 
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles['wrapper-container']}>
        {isEmpty(JSON?.parse(localStorage.getItem('user'))) && ( // kiểm tra user chưa login
        ...
        {!isEmpty(JSON?.parse(localStorage.getItem('user'))) && JSON?.parse(localStorage.getItem('pageCurrent'))?.length === 0 && ( // đã login nhưng chưa được add vào page 
          <div className={styles['wrapper-login']}>
            <div
              className={styles['button-login']}
            >
        ...
        {!isEmpty(JSON?.parse(localStorage.getItem('pageCurrent'))) && ( // đã login và có page  
          <>
