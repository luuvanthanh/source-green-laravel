...
const mapStateToProps = ({ crmReviewScenario, loading }) => ({
  data: crmReviewScenario.data,
  error: crmReviewScenario.error,
  pagination: crmReviewScenario.pagination,
  loading,
});
...
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'crmReviewScenario/GET_DATA',
      payload: {
        ...search,
      },
    });
 ...
 */
  ...
  render() {
    ...
    const { search } = this.state;
    const loading = effects['crmReviewScenario/GET_DATA'];
    return (
      <>
