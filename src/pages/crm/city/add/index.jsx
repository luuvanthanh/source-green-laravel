...
const mapStateToProps = ({ menu, loading, crmCityAdd }) => ({
  loading,
  menuData: menu.menuLeftCRM,
  details: crmCityAdd.details,
  error: crmCityAdd.error,
  paramaterValues: crmCityAdd.paramaterValues,
});
...
class Index extends PureComponent {
  ...
  onFinish = (values) => {
    ...
    dispatch({
      type: params.id ? 'crmCityAdd/UPDATE' : 'crmCityAdd/ADD',
      payload,
  ...
  render() {
    ...
    const loadingSubmit = effects['crmCityAdd/ADD'] || effects['crmCityAdd/UPDATE'];
    const loading =
      effects['crmCityAdd/GET_DETAILS'];
    return (
      <>
        <Breadcrumbs
