...
const mapStateToProps = ({ menu, loading, crmChildrensProblemsAdd }) => ({
  loading,
  menuData: menu.menuLeftCRM,
  details: crmChildrensProblemsAdd.details,
  error: crmChildrensProblemsAdd.error,
  paramaterValues: crmChildrensProblemsAdd.paramaterValues,
});
...
class Index extends PureComponent {
  ...
  cancel = (id) => {
    ...
    return Helper.confirmAction({
      callback: () => {
        dispatch({
          type: 'crmChildrensProblemsAdd/REMOVE',
          payload: {
            id,
          },
          callback: (response) => {
  ...
  componentDidMount() {
    ...
    if (params.id) {
      dispatch({
        type: 'crmChildrensProblemsAdd/GET_DETAILS',
        payload: params,
      });
    }
    dispatch({
  ...
  onFinish = (values) => {
    ...
    dispatch({
      type: params.id ? 'crmChildrensProblemsAdd/UPDATE' : 'crmChildrensProblemsAdd/ADD',
      payload,
  ...
  render() {
    ...
    const loadingSubmit = effects['crmChildrensProblemsAdd/ADD'] || effects['crmChildrensProblemsAdd/UPDATE'];
    const loading = effects['crmChildrensProblemsAdd/GET_DETAILS'];
    return (
      <>
