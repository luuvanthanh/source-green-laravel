...
const mapStateToProps = ({ menu, loading, crmParentsLeadAdd }) => ({
  loading,
  menuData: menu.menuLeftCRM,
  details: crmParentsLeadAdd.details,
  error: crmParentsLeadAdd.error,
  paramaterValues: crmParentsLeadAdd.paramaterValues,
});
...
class Index extends PureComponent {
  ...
  componentDidMount() {
    ...
    if (params.id) {
      dispatch({
        type: 'crmParentsLeadAdd/GET_DETAILS',
        payload: params,
      });
    }
  }
  ...
  onFinish = (values) => {
    ...
    dispatch({
      type: params.id ? 'crmParentsLeadAdd/UPDATE' : 'crmParentsLeadAdd/ADD',
      payload,
  ...
  render() {
    ...
    const loadingSubmit = effects['crmParentsLeadAdd/ADD'] || effects['crmParentsLeadAdd/UPDATE'];
    const loading = effects['crmParentsLeadAdd/GET_DETAILS'];
    return (
      <>
