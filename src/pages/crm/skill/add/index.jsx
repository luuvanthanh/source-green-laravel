...
const mapStateToProps = ({ menu, loading, crmSkillAdd }) => ({
  loading,
  menuData: menu.menuLeftCRM,
  details: crmSkillAdd.details,
  error: crmSkillAdd.error,
  paramaterValues: crmSkillAdd.paramaterValues,
});
...
class Index extends PureComponent {
  ...
  render() {
    ...
    const loadingSubmit = effects['crmSkillAdd/ADD'] || effects['crmSkillAdd/UPDATE'];
    const loading =
      effects['crmSkillAdd/GET_DETAILS'];
    return (
      <>
        <Breadcrumbs
