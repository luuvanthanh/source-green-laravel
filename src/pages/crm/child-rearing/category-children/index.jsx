      ...
      render: (record) => (
        <div className="d-flex justify-content-end">
          ...
          />
          {
            ...
            <Button permission="WEB_KIENTHUCNUOIDAYTRE_DANHSACHBAIVIET_DELETE" className='ml10' color="danger" icon="remove" onClick={(e) => {
              e.stopPropagation();
              onRemove(record.id);
            }
            }
    ...
    <>
      ...
      <Pane className={csx(styles['content-form'], styles['content-form-children'])}>
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <Button permission="WEB_KIENTHUCNUOIDAYTRE_DANHSACHBAIVIET_CREATE" color="success" icon="plus" onClick={() => history.push(`${pathname}/tao-moi`)}>
            Thêm mới
          </Button>
        </div>
        <Pane className="card">
