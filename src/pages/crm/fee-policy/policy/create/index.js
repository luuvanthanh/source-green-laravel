...
const Index = memo(() => {
  ...
  const { menuLeftCRM, yearsSchool, branches } = useSelector(
  ...
  return (
    <Form layout="vertical" colon={false} ref={formRef} onFinish={finishForm}>
      <Breadcrumbs className="pb0" last={params?.id ? 'Chi tiết' : 'Thêm mới'} menu={menuLeftCRM} />
            ...
            <>
              <Pane className="card mb0">
                ...
                >
                  ...
                  <Tabs onChange={changeTab} activeKey={tab} className="test-12 pb20">
