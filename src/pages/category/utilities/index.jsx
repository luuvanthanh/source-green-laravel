...
const { confirm } = Modal;
const mapStateToProps = ({ utilities, loading }) => ({
  data: utilities.data,
...
class Index extends PureComponent {
  ...
  onFinish = () => {
    ...
    this.formRef.current.validateFields().then((values) => {
      this.props.dispatch({
        type: !isEmpty(objects) ? 'utilities/UPDATE' : 'utilities/ADD',
        payload: {
          ...values,
          id: objects.id,
        },
  ...
  render() {
    ...
    const loadingSubmit = effects['utilities/ADD'] || effects['utilities/UPDATE'];
    return (
      <div className={styles['layout-form']}>
        <Helmet title="Danh mục tiện ích" />
        <Modal
          centered
          footer={[
          ...
          title={!isEmpty(objects) ? 'CHỈNH SỬA TIỆN ÍCH' : 'THÊM MỚI TIỆN ÍCH'}
          visible={visible}
        >
        ...
        <div className={classnames(styles['content-form'], styles['content-form-children'])}>
          <div className="d-flex justify-content-between align-items-center mt-4 mb-4">
            <Text color="dark">DANH MỤC TIỆN ÍCH</Text>
            <Button
              color="success"
              icon="plus"
              onClick={() =>
