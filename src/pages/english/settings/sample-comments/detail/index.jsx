...
const General = memo(() => {
  ...
  const { menuLeftEnglish, details, loading: { effects } } = useSelector(({ menu, englishSettingSampleCommentsAdd, loading }) =>
  ({
    loading,
  ...
  return (
    <>
      <Breadcrumbs last={details?.type} menu={menuLeftEnglish} />
