...
class AssessmentPeriodRepositoryEloquent extends BaseRepository implements AssessmentPeriodRepository
{
    ...
    public function getAll(array $attributes)
    {
        ...
        if (!empty($attributes['periodic']) && $attributes['periodic'] == 'true') {
            $this->model = $this->model->where('Periodic', true);
        }
        ...
        if (!empty($attributes['introduction']) && $attributes['introduction'] == 'true') {
            $this->model = $this->model->where('Introduction', true);
        }
