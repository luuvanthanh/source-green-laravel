...
class RouteRegistrar extends CoreRegistrar
{
     ...
     */
    protected static $namespace = '\GGPHP\Facebook\Http\Controllers';
    ...
    public function forBread()
    {
        $this->router->group(['middleware' => []], function ($router) {
            \Route::group(['prefix' => 'facebook'], function () {
                ...
                \Route::post('pages/conversations/send-messages', 'FacebookController@getPageConversationSendMessageFacebook');
