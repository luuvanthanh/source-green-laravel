...
class PostFacebookInfoController extends Controller
{
    /**
     ...
     */
    public function __construct(PostFacebookInfoRepository $postFacebookInfoRepository)
    {
    ...
    {
        $postFacebookInfo = $this->postFacebookInfoRepository->getPostFacebookInfo($request->all());
    ...
    {
        $this->postFacebookInfoRepository->deletePostFacebookInfo($id, $request->all());
