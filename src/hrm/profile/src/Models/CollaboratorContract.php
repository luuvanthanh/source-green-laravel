...
class CollaboratorContract extends UuidModel
{
    public $incrementing = false;

    protected $table = 'CollaboratorContracts';
    ...
    {
        return $this->belongsToMany(\GGPHP\Category\Models\ParamaterValue::class, 'CollaboratorContractParameterValue', 'CollaboratorContractId', 'ParameterValueId')->withPivot('Value');
    }
