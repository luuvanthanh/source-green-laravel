<?php
namespace GGPHP\LateEarly\Services;

use GGPHP\Absent\Models\RevokeShift;
use GGPHP\LateEarly\Models\LateEarly;
use GGPHP\LateEarly\Models\WorkDeclarationDetail;
        ...
        foreach ($attributes as $value) {
            switch ($value['type']) {
                case 'invalid':
                    ...
                    LateEarly::where('id', $value['model_id'])->update(['status_work_declaration' => 'PROCESS']);
