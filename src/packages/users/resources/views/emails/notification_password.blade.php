              ...
              <table class="inner-body" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                ...
                <tr>
                  <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; font-size: 13px; margin-top: 0; text-align: left;"><b>Xin chào</b> <i>{{$data['name']}}</i> !</p>
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; font-size: 13px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Tài khoản của Ông/Bà đã được tạo trên hệ thống <i>GSDL</i></b></p>
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; font-size: 13px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Email đăng nhập:</b> <i>{{$data['email']}}</i></p>
                    ...
                    <p><a href="{{$data['url_login']}}" style="font-family: Avenir, Helvetica, sans-serif;line-height: 1.5em; box-sizing: border-box; color: #3869D4;">Đăng nhập</a></p>
                    ...
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; font-size: 13px; line-height: 1.5em; margin-top: 0; text-align: left;"><b><i>Hệ thống GSDL</i></b></p>
                    </p>
                  </td>
                </tr>
              </table>
