...
class CreateParameterChangesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fee.ChangeParameters', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fee.ChangeParameters');
    }
}
